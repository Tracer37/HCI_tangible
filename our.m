...
data = load("../scissors_labels.mat");
trainingData_our = data.gTruth;

% Create an image datastore for loading the images.
imdsTrain = imageDatastore(trainingData_our.DataSource.Source);
imdsTest = imageDatastore(testDataTbl.imageFilename);
 
% Create a datastore for the ground truth bounding boxes.
bldsTrain = boxLabelDatastore(trainingData_our.LabelData);
